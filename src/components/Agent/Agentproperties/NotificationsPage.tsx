  ...
  return (
    <div className="px-12">
      <div className="flex justify-between">
        <h1 className="font-semibold text-2xl py-4 w-fit">Transactions</h1>
            ...
            {IsPopOverA && (
              <div className="bg-white w-64 h-fit flex flex-col py-3 shadow-md shadow-slate-500 absolute top-11">
                {TranscationSortType.map((item, index) => (
                  <span
                    key={index}
                    className="hover:bg-[#4959EE] hover:text-white px-3 py-1"
                  >
                    {item}
                  </span>
                ))}
      ...
      <div className="flex flex-col gap-2">
        {TransData.map(
          (
            ...
            <div
              className="w-full flex flex-row justify-between items-center p-2 border-b border-[#B7C4CA]"
              key={index}
            >
              <div>
                <p
              ...
              <div className="flex items-center gap-10">
                <div className="flex gap-2">
                  <button className="text-[#797A81] border border-[#797A81] px-3 py-1 rounded-md">
                    review
                  </button>
                  <button className="text-white border border-homeLightBlue bg-homeLightBlue px-3 py-1 rounded-md">
                    approve
                  </button>
                </div>
      ...
      <div className="text-xs flex gap-1 flex-col items-end my-3">
